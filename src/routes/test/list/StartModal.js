        ...
        return (
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
                Interactive mammogram interpretation to improve breast
                cancer detection- module M1<span style={{background: 'lime', msoHighlight: 'lime'}}><br/>
                </span>December 1, 2019 – November 30, 2020
              </span>
            </span>
                                </p>
            ...
            <span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: '#333333'}}><br/>
              ...
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif'}}>
                This educational activity based on
                radiologic test sets and an interactive platform are designed to improve the
                diagnostic efficacy of radiologists and other clinicians. Each individual will
                be asked to assess clinically relevant mammographic images and try to identify
                a cancer (if one is present) and recognize images without cancer.<span style={{msoSpacerun: 'yes'}}>&nbsp; </span>Each individual will receive immediate
                feedback with scores for sensitivity, specificity and receiver operating
                characteristic (ROC). Personalized image files for each case judged will then
                be instantly provided showing correct decisions and any errors made.<span style={{msoSpacerun: 'yes'}}>&nbsp; </span>At the end there will be an 8-image posttest
                and if passed a CME certificate will be issued.
              </span>
            </span>
                                </p>
                                <p className="MsoNormal" style={{marginBottom: '.0001pt', lineHeight: 'normal'}}>
            <span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: '#333333'}}><br/>
              ...
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
                ...
                involved in judging radiologic images.
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  ...
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>At
                the end of this module, the user will be able to</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  style={{font: '7.0pt "Times New Roman"'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>Recognise
                a range of cancer appearances demonstrated in the image learning set and
                therefore maximise cancer detection;</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  style={{font: '7.0pt "Times New Roman"'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>Be
                aware of the range of appearances of images without cancer and therefore
                minimise unnecessary call-backs;</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  style={{font: '7.0pt "Times New Roman"'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>Improve
                perception and interpretation skills in the reading of digital mammograms;</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  style={{font: '7.0pt "Times New Roman"'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>Demonstrate
                an awareness of any personal weaknesses when searching for cancers or trying to
                recognise normal images;</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                  style={{font: '7.0pt "Times New Roman"'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </span></span></span><span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"', color: 'black', msoColorAlt: 'windowtext'}}>Assess
                detailed scores on personal performance levels using 5 internationally
                recognised metrics;</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
            ...
            <span>
              <span style={{fontSize: '10.0pt', fontFamily: 'Symbol', msoFareastFontFamily: 'Symbol', msoBidiFontFamily: 'Symbol'}}><span style={{msoList: 'Ignore'}}>·<span
                ...
                increased confidence when interpreting radiologic images.</span>
            </span>
                                    <span>
              <span style={{fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"'}}>
              </span>
