          ...
          <div lang="EN-US" link="blue" vlink="#954F72" style={{ tabInterval: '36.0pt', height: '70vh', overflow: 'auto' }}>
            <div className="WordSection1">
              ...
              <p className="MsoNormal" align="center" style={{ marginBottom: '.0001pt', textAlign: 'center', lineHeight: 'normal' }}>
                <span>
                  <span style={{ fontSize: '10.0pt', fontFamily: '"Arial",sans-serif', msoFareastFontFamily: '"Times New Roman"' }}>
                    {this.props.name}<span style={{ background: 'lime', msoHighlight: 'lime' }}><br />
                    </span>
                  </span>
                </span>
              </p>
              <p className="MsoNormal" style={{ marginBottom: '.0001pt', lineHeight: 'normal' }}>
                ...
                <span>
                  <span style={{ fontSize: '10.0pt', fontFamily: '"Arial",sans-serif' }}>
                    ...
                    Each individual will be asked to assess clinically relevant mammographic images and try to identify a cancer (if one is present) and recognize images without cancer.
                  ...
                  At the end there will be a {this.props.postTestCount}-image posttest and if passed a CME certificate will be issued.
              </span>
                </span>
              </p>
              <p className="MsoNormal" style={{ marginBottom: '.0001pt', lineHeight: 'normal' }}>
              ...
              <p className="MsoNormal" style={{ marginBottom: '.0001pt', lineHeight: 'normal' }}>
                ...
                maximum of {this.props.credit} <i>AMA PRA Category 1 Credit(s)™</i>. Physicians should claim
