...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.testSetAssignmentsList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.testSetAssignmentsDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.test_set_id !== '' && addNewItemDetail.user_id !== '') {
            this.setState({addNewItemModal: false, loading: true});
            let self = this;
            Apis.testSetAssignmentsAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.user_id !== '' && editItem.test_set_id !== '') {
            ...
            let self = this;
            Apis.testSetAssignmentsUpdate(editItem.id, editItem).then(resp => {
    ...
    render() {
        ...
        return (
            <div className="item-management">
                <Helmet>
                    <title>Test Set Assignments Management</title>
                    <meta name="description" content=""/>
                </Helmet>
                <PageTitleBar
                    title={"Test Set Assignments"}
                    ...
                    <ModalBody>
                        {editItem === null ?
                            <AddNewForm
                                ...
                                testSetsList={this.state.testSetsList}
                            /> :
                            <UpdateForm
                                item={editItem}
                            ...
                            <div className="clearfix d-flex">
                                <div className="media pull-left">
                                    <div className="media-body">
                                        ...
                                        <p>Test Set: <span className="fw-bold">{selectedItem.test_sets.name}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
