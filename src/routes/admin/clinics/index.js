...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.clinicsList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.clinicsDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.name !== '') {
            ...
            let self = this;
            Apis.clinicsAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.name !== '') {
            ...
            let self = this;
            Apis.clinicsUpdate(editItem.id, editItem).then(resp => {
    ...
    render() {
        ...
        return (
            <div className="item-management">
                <Helmet>
                    <title>Clinics Management</title>
