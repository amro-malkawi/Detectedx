...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.metricsList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.metricsDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.name !== '') {
            ...
            let self = this;
            Apis.metricsAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.name !== '' ) {
            ...
            let self = this;
            Apis.metricsUpdate(editItem.id, editItem).then(resp => {
                            ...
                            <div className="clearfix d-flex">
                                <div className="media pull-left">
                                    <div className="media-body">
                                        ...
                                        <p>Range: <span className="fw-bold">{selectedItem.range}</span></p>
                                        <p>Description: <span className="fw-bold">{selectedItem.description}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
