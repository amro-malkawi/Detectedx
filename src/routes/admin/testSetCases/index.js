...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.testSetCasesList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.testSetCasesDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.test_set_id !== '' && addNewItemDetail.test_case_id !== '') {
            this.setState({addNewItemModal: false, loading: true});
            let self = this;
            Apis.testSetCasesAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.test_case_id !== '' && editItem.test_set_id !== '') {
            ...
            let self = this;
            Apis.testSetCasesUpdate(editItem.id, editItem).then(resp => {
    ...
    render() {
        ...
        return (
            <div className="item-management">
                <Helmet>
                    <title>Test Set Cases Management</title>
                    <meta name="description" content=""/>
                </Helmet>
                <PageTitleBar
                    title={"Test Set Cases"}
