...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.modalitiesList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.modalitiesDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.name !== '') {
            ...
            let self = this;
            Apis.modalitiesAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.name !== '') {
            ...
            let self = this;
            Apis.modalitiesUpdate(editItem.id, editItem).then(resp => {
    ...
    render() {
        ...
        return (
            <div className="item-management">
                <Helmet>
                    <title>Modalities Management</title>
                            ...
                            <div className="clearfix d-flex">
                                <div className="media pull-left">
                                    <div className="media-body">
                                        ...
                                        <p>Address: <span className="fw-bold">{selectedItem.address}</span></p>
                                        <p>Postcode: <span className="fw-bold">{selectedItem.postcode}</span></p>
                                        <p>State: <span className="fw-bold">{selectedItem.state}</span></p>
                                        <p>Country: <span className="fw-bold">{selectedItem.country}</span></p>
                                        <p>Email: <span className="fw-bold">{selectedItem.email}</span></p>
                                        <p>Phone: <span className="fw-bold">{selectedItem.phone}</span></p>
