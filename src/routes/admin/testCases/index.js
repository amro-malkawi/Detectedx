...
export default class TestSets extends Component {
    ...
    getItemList() {
        Apis.testCasesList(this.state.currentPage).then((data) => {
            this.setState({
                loading: false,
                items: data.data,
    ...
    deleteItemPermanently() {
        ...
        Apis.testCasesDelete(selectedItem.id).then(resp => {
    ...
    addNewItem() {
        ...
        if (addNewItemDetail.name !== '' && addNewItemDetail.modality_id !== '') {
            ...
            let self = this;
            Apis.testCasesAdd(this.state.addNewItemDetail).then(resp => {
    ...
    updateItem() {
        ...
        if (editItem.name !== '' && editItem.modality_id !== '') {
            ...
            let self = this;
            Apis.testCasesUpdate(editItem.id, editItem).then(resp => {
    ...
    render() {
        ...
        return (
            <div className="item-management">
                <Helmet>
                    <title>Test Cases Management</title>
                            ...
                            <div className="clearfix d-flex">
                                <div className="media pull-left">
                                    <div className="media-body">
                                        ...
                                        <p>Orthanc: <span className="fw-bold">{selectedItem.orthanc}</span></p>
                                        <p>Truths: <span className="fw-bold">{selectedItem.truths}</span></p>
